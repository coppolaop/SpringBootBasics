...
class TaskServiceTest {
	...
	void setUp( ) {
		...
		Task task1 = new Task( 1L, "Configurar Mockito", "Configurar os mocks para teste unitário",
							   false, LocalDateTime.now( ), null );
		Task task2 = new Task( 2L, "Criar testes unitários",
	...
	@Test
	void create( ) {
		Task task = new Task( 1L, "Configurar Mockito", "Configurar os mocks para teste unitário",
